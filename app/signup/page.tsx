    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6" style={{background: '#080808'}}>
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm tracking-widest uppercase" style={{color: '#E8440C'}}>Create Account</p>
        </div>
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          ...
          {gymCode && (
            <div className="rounded-lg px-4 py-3" style={{background: '#0F0F0F', border: '1px solid #E8440C'}}>
              <p className="text-xs" style={{color: '#E8440C'}}>✓ You'll be joined to your gym automatically</p>
            </div>
          )}
        ...
        <p className="text-center mt-6" style={{color: '#6B5E55'}}>
          ...
          <a href={gymCode ? `/login?gym=${gymCode}` : '/login'} style={{color: '#E8440C'}}>Log In</a>
        </p>
      </div>
    </main>
  )
