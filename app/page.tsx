    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6" style={{background: '#080808'}}>
      <div className="text-center">
        ...
        <div className="flex flex-col gap-4">
          <a href="/login" className="px-8 py-3 rounded-full font-semibold text-white" style={{background: '#E8440C'}}>
            Log In
          </a>
          <a href="/signup" className="px-8 py-3 rounded-full font-semibold border text-white" style={{borderColor: '#E8440C', color: '#E8440C'}}>
            Sign Up
          </a>
        </div>
      </div>
